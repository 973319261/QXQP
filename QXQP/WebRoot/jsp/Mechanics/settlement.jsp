   ...
   <!--  @*结算模态框*@ -->
    ...
    <script>
        ...
        function addThree() {
            ...
            createSelect("QA" + length, "${cxt}/servlet/CommonServlet?t=SYS_Expenses");
            ...
            function Bave()
            {
                layer.confirm('是否保存当前信息？', {
                    ...
                    $.post("${cxt}/servlet/CustomerServlet?fun=updateListReceptione", {
                        ...
                        SYS_RecProductDetail: JSON.stringify(ArrCollageDetai), SYS_RecOtherCostDetail: JSON.stringify(ArrRecOtherCost),
