...
<body>
    ...
    <nav class="breadcrumb" style="margin:0px">
        ...
        <span class="c-gray en">&gt;</span><a href=""> 三 包 索 赔 结 算</a>
   ...
   <!--  @*按钮栏*@ -->
    <div class="cl pd-5 bg-1 bk-gray mt-20" style="padding:10px;margin:0px">
        ...
        <button class="btn btn-danger "onclick="DelectThreePacks()" id="btnDelect"><i class="Hui-iconfont">&#xe609;</i> 删 除</button>
   ...
   <!--  @*控件栏*@ -->
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend style="margin-left:50px;text-shadow: 5px 5px 5px gray;font-weight:inherit">三 包 索 赔 结 算</legend>
        <div class="layui-field-box">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <form class="form-horizontal" role="form" style="margin-top:2px;" id="fromThreePacks">
                        <input type="text" hidden id="ThreePacksID" name="ThreePacksID" />
                        <input type="text" hidden id="ThreePacksDetailID" name="ThreePacksDetailID" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2 col-md-3 col-xs-12">
                                <input type="text" class="form-control disabl"id="Operator"disabled value="${user.getUserName() }">
                            </div>
                            <div class="col-lg-1 col-md-1 col-xs-12">
                ...
                <div class="modal-body" style="padding-top:0">
                    ...
                    <fieldset class="layui-elem-field layui-field-box" style="margin-top: 20px;">
                        ...
                        <form class="form-horizontal" role="form" style="margin-top:2px;"id="formBalance">
                            <input hidden id="ReceptionID" value="${receptionID }" />
                            <input hidden id="BalanceID" /><!-- @*结算ID*@ -->
    ...
    <script>
        ...
        $(function () {
            ...
            tbDanJu = $.fn.bsgrid.init('tbDanJu', {
                url: '${cxt}/servlet/ClaimsetServlet?fun=selectThreePacks',
                autoLoad: false,//自动加载
            ...
            tbDanHao = $.fn.bsgrid.init('tbDanHao', {
                url: '${cxt}/servlet/ClaimsetServlet?fun=selectDanHao',
                autoLoad: false,//自动加载
                stripeRows: true,//隔行变色
                rowHoverColor: true,//划过行变色
                displayBlankRows: false,//是否显示空白行, 默认值true
        ...
        function InsuranceNum() {
            $.post("${cxt}/servlet/ClaimsetServlet?fun=insuranceNum", function (data) {
        ...
        function MianDatas() {
            ...
            if (ReceptionID != "") {
                ...
                $.getJSON("${cxt}/servlet/ClaimsetServlet?fun=selectThreePackss&ReceptionID=" + ReceptionID, function (data) {
                    data=data.list[0];
                    DanHaoData(data);
                })
            } else {
            ...
            $.post("${cxt}/servlet/ClaimsetServlet?fun=clearClaimset");
        }
        /********************主页面---开始******************************/
        //删除数据
        function DelectThreePacks()
        {
            ...
            if (ThreePacksID != 0) {
                $.post("${cxt}/servlet/ClaimsetServlet?fun=delectThreePacks&ThreePacksID=" + ThreePacksID, function (data) {
                    if (data) {
                        layer.msg("删 除 成 功 ！");
                        SeleceDanJu();
                        Clear();
        ...
        function BavaMian()
        {
            ...
            if (MaintenanceNum == "") {
                ...
                $.post("${cxt}/servlet/ClaimsetServlet?fun=bavaThreePacks", { PW_ThreePacks: JSON.stringify(ArrThreePacks), ClaimComID: $("#ClaimComID").val() }, function (data) {
                    if (data>0) {
                        SeleceDanJu()
        ...
        function TOAudit() {
            ...
            if (ThreePacksID != "") {
                $("#ToAudit").val("true");
                $.post("${cxt}/servlet/ClaimsetServlet?fun=toAudit&ThreePacksID=" + ThreePacksID, function (data) {
                    if (data>0) {
        ...
        function TONotAudit() {
            ...
            $.getJSON("${cxt}/servlet/ClaimsetServlet?fun=selectBalance&BusinessNum=" + InsuranceNum, function (data) {
                ...
                if (data.state && data.states!="A") {
                    $.post("${cxt}/servlet/ClaimsetServlet?fun=toNotAudit&ThreePacksID=" + $("#ThreePacksID").val(), function (data) {
                        if (data) {
        ...
        function MianData(record)
        {
          console.log(record);
          Clear();
          $.getJSON("${cxt}/servlet/ClaimsetServlet?fun=selectReceptionDetail&ReceptionID=" + record.receptionID, function (data) {
              data=data.list;
        ...
        function DanHaoData(record)
        {
            ...
            $.getJSON("${cxt}/servlet/ClaimsetServlet?fun=selectThreePacksData&ThreePacksDetailID=" + ThreePacksDetailID, function (data) {
                data=data.list[0];
                console.log(data);
                if (data != null) {
                    DanJuData(data);
