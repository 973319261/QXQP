...
public class ExpensesVo implements java.io.Serializable {
	...
	/** minimal constructor */
	public ExpensesVo(String expensesName) {
		this.expensesName = expensesName;
	}

	/** full constructor */
	public ExpensesVo(String expensesName, Double cost, Double price,
