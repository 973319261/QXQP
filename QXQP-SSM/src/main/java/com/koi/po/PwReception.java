...
public class PwReception implements java.io.Serializable {
	...
	public PwReception(Integer receptionId, Integer documentStateId,
			...
			Boolean toCompletion, String customerNum) {
		super();
