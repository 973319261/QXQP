    ...
    <script>
        ...
        $(function () {
            ...
            tbLingLiao = $.fn.bsgrid.init('tbLingLiao', {
                url: '${cxt}/collageController/selectReception.action',
                autoLoad: false,//自动加载
            ...
            tbTuiLiao = $.fn.bsgrid.init('tbTuiLiao', {
                url: '${cxt}/collageController/selectTableCollageDetai.action',
                autoLoad: false,//自动加载
                stripeRows: true,//隔行变色
                rowHoverColor: true,//划过行变色
                displayBlankRows: false,//是否显示空白行, 默认值true
        ...
        function Collage()
        {
            ...
            if (rowIndex > -1) {
                if (record.toAudit != true) {
                    $.post("${cxt}/collageController/collage.action?receptionID=" + record.receptionId, function (data) {
            ...
            if (rowIndex > -1) {
                if (record.toAudit != true) {
                    if (record.collageState == "未领料") {
                        ...
                        $.post("${cxt}/collageController/selectCollageToID.action?receptionID=" + record.receptionId, function (data) {
        ...
        function Restock() {
            ...
            $.post("${cxt}/collageController/restock.action", { sysCollageDetai: JSON.stringify(checkedRows) }, function (data) {
