    ...
    <script>
        ...
        $(function () {
            tbReception = $.fn.bsgrid.init('tbReception', {
                url: '${cxt}/completionController/selectReception.action',
                autoLoad: false,//自动加载
        ...
        function CompletionTrue()
        {
            ...
            if (record.length > 0) {
                $.post("${cxt}/completionController/updateCompletionTrue.action", { receptionVo: JSON.stringify(ReceptionID) }, function (data) {
                    if (data>0) {
                        SelectReception()
                        layer.msg("修 改 成 功 !")
                    } else {
        ...
        function CompletionFalse()
        {
            ...
            $.post("${cxt}/completionController/updateCompletionFalse.action", { receptionVo: JSON.stringify(ReceptionID) }, function (data) {
                    if (data>0) {
                        SelectReception()
                        layer.msg("修 改 成 功 !")
                    }
