   ...
   <!--  @*结算单模态框*@ -->
    ...
    <script>
        ...
        function addTow()
        {
            var ReceptionID = $("#ReceptionID").val();
            if (ReceptionID != "") {
                $.post("${cxt}/collageController/collage.action?receptionID=" + ReceptionID, function (data) {
        ...
        function MaintenanceNum() {
            $.post("${cxt}/rapidrepairController/maintenanceNum.action", function (data) {
        ...
        {
            if (ReceptionID!="") {
            $.getJSON("${cxt}/dispatchingController/selectReception.action?receptionID=" +ReceptionID, function (data) {
                ReceptionData(data);
        ...
        function btnMainSava(num) {
            ...
            function Bave()
            {
                layer.confirm('是否保存当前信息？', {
                 ...
                 $.post("${cxt}/rapidrepairController/updateListReceptione.action", {
                        ...
                        if (data != false) {
                            if (num == 0) {
                                ...
                                $.post("${cxt}/collageController/collage.action?receptionID=" + data, function (data) {
                                    window.location.href = "${cxt}/jsp/Mechanics/rapatchingCollage.jsp";
                                })
                            }
                        } else {
        ...
        function TONotAudit() {
            ...
            $.getJSON("${cxt}/claimsetController/selectBalance.action?businessNum=" + MaintenanceNum, function (data) {
        ...
        function ShowJieSuan() {
            $.getJSON("${cxt}/claimsetController/selectBalance.action?businessNum=" + $("#MaintenanceNum").text(), function (data) {
              $("#BalanceID").val("");
                if (data.state) {
                    if(data.text!=null){
                     $("#BalanceID").val(data.text);
                    $.getJSON("${cxt}/claimsetController/selectBalances.action?balanceID=" + $("#BalanceID").val(), function (data) {
