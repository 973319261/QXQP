	...
	<script>
        ...
        $(function () {
            ...
            tbDanJu = $.fn.bsgrid.init('tbDanJu', {
                url: '${cxt}/claimsetController/selectThreePacks.action',
                autoLoad: false,//自动加载
            ...
            tbDanHao = $.fn.bsgrid.init('tbDanHao', {
                url: '${cxt}/claimsetController/selectDanHao.action',
                autoLoad: false,//自动加载
                stripeRows: true,//隔行变色
                rowHoverColor: true,//划过行变色
                displayBlankRows: false,//是否显示空白行, 默认值true
        ...
        function create() {
            ...
            appendOption("HDocumentStateID", "${cxt}/commonController/selectAppendOption.action?type=SYS_DocumentState");//单据状态下拉框
            appendOption("HBalanceStateID", "${cxt}/commonController/selectAppendOption.action?type=SYS_BalanceState");//结算状态下拉框
        ...
        function InsuranceNum() {
            $.post("${cxt}/claimsetController/insuranceNum.action", function (data) {
        ...
        function MianDatas() {
            if (ReceptionID != "") {
                $.getJSON("${cxt}/claimsetController/selectThreePackss.action?receptionID=" + ReceptionID, function (data) {
                    DanHaoData(data[0]);
                })
            } else {
                SeleceDanJu();
            }
            $.post("${cxt}/claimsetController/clearClaimset.action");
        }
        /********************主页面---开始******************************/
        //删除数据
        function DelectThreePacks()
        {
            ...
            if (ThreePacksID != 0) {
                $.post("${cxt}/claimsetController/delectThreePacks.action?threePacksID=" + ThreePacksID, function (data) {
                    if (data) {
                        layer.msg("删 除 成 功 ！");
                        SeleceDanJu();
                        Clear();
        ...
        function BavaMian()
        {
            ...
            if (MaintenanceNum == "") {
                ...
                $.post("${cxt}/claimsetController/bavaThreePacks.action", { pwThreePacks: JSON.stringify(ArrThreePacks), claimComID: $("#ClaimComID").val()}, function (data) {
                    if (data>0) {
                        SeleceDanJu()
        ...
        function TOAudit() {
            ...
            if (ThreePacksID != "") {
                $("#ToAudit").val("true");
                $.post("${cxt}/claimsetController/toAudit.action?threePacksID=" + ThreePacksID, function (data) {
                    if (data>0) {
        ...
        function TONotAudit() {
            ...
            $.getJSON("${cxt}/claimsetController/selectBalance.action?businessNum=" + InsuranceNum, function (data) {
                if (data.state && data.states!="A") {
                    $.post("${cxt}/claimsetController/toNotAudit.action?threePacksID=" + $("#ThreePacksID").val(), function (data) {
                        if (data) {
        ...
        {
          Clear();
          $.getJSON("${cxt}/claimsetController/selectReceptionDetail.action?receptionID=" + record.receptionId, function (data) {
        ...
        function DanHaoData(record)
        {
            ...
            $.getJSON("${cxt}/claimsetController/selectThreePacksData.action?threePacksDetailID=" + ThreePacksDetailID, function (data) {
                if (data != null) {
                    DanJuData(data[0]);
                } else {
                    MianData(record);
        ...
        function ShowJieSuan() {
            $.getJSON("${cxt}/claimsetController/selectBalance.action?businessNum=" + $("#InsuranceNum").val(), function (data) {
                if (data.state) {
                    if ($("#Amount").val() < 0) {
        ...
        function JieSuanData() {
            ...
            $("#Remark").val("");
            if (BalanceID != "") {
                $.getJSON("${cxt}/claimsetController/selectBalances.action?balanceID=" + BalanceID, function (data) {
        ...
        function btnBaveJieSuan() {
            ...
            if ($("#PaymentID").val() == 0) {
                ...
                $.post("${cxt}/claimsetController/baveBalance.action", { pwBalance: JSON.stringify(ArrBalance) }, function (data) {
                    if (data>0) {
                        layer.msg("结 算 成 功 !");
                        SeleceDanJu();
