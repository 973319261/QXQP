						...
						<fieldset class="layui-elem-field layui-field-box"
							...
							<div class="col-lg-12 col-md-12 col-sm-12" style="width:102%">
								<form class="form-horizontal" id="InfoForm"
									action="${cxt}/commonAction!updateFittingsInfo.action"
									...
									<input type="hidden" name="sysFittingsInfo.invenQuan" vaule="0.0" />
									<div
										...
										<div class="form-group">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="text" class="form-control" id="PFittingsCode"
													name="sysFittingsInfo.fittingsCode" maxlength="5">
											</div>
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<select class="form-control" id="PFittingsTypeID"
													name="sysFittingsInfo.fittingsTypeId"></select>
											</div>
										</div>
										<div class="form-group">
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="text" class="form-control" id="PFittingsName"
													name="sysFittingsInfo.fittingsName" maxlength="10">
											</div>
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="text" class="form-control" id="PBarcode"
													name="sysFittingsInfo.barcode" maxlength="10">
											</div>
										</div>
										<div class="form-group">
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="text" class="form-control" id="PSpecification"
													name="sysFittingsInfo.specification" maxlength="10">
											</div>
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="text" class="form-control" id="PBrand"
													name="sysFittingsInfo.brand" maxlength="5">
											</div>
										</div>
										<div class="form-group">
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<select class="form-control" id="PSystemUnitID"
													name="sysFittingsInfo.systemUnitId"></select>
											</div>
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<select class="form-control" id="PVehicleTypeID"
													name="sysFittingsInfo.vehicleTypeId"></select>
											</div>
										</div>
										<div class="form-group">
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="number" class="form-control" id="PSalesPrice"
													name="sysFittingsInfo.salesPrice">
											</div>
										</div>
										<div class="form-group">
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="number" class="form-control"
													id="PWholesalePrice" name="sysFittingsInfo.wholesalePrice">
											</div>
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="number" class="form-control" id="PInventoryMax"
													name="sysFittingsInfo.inventoryMax">
											</div>
										</div>
										<div class="form-group">
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="number" class="form-control" id="PInventoryMin"
													name="sysFittingsInfo.inventoryMin">
											</div>
											<div class="col-lg-3 col-md-3 col-xs-12">
											...
											<div class="col-lg-4 col-md-4 col-xs-12">
												<input type="number" class="form-control" id="POpenPrice"
													name="sysFittingsInfo.openPrice">
											</div>
										</div>
									</div>
									<div class="form-group" style="padding-top:30px">
										...
										<div class="col-lg-4 col-md-4 col-xs-12">
											<select class="form-control" id="PSuppliersID"
												name="sysFittingsInfo.suppliersId"></select>
										</div>
										...
										<div class="col-lg-4 col-md-4 col-xs-12">
											<input type="text" class="form-control" style="width:300px"
												id="PRemark" name="sysFittingsInfo.remark" maxlength="20">
										</div>
									</div>
									<p
	...
	<script>
        ...
        $(function () {
            ...
            tbDanJu = $.fn.bsgrid.init('tbDanJu', {
                url: '${cxt}/appointmentAction!selectPredate.action',
                autoLoad: false,//自动加载
                stripeRows: true,//隔行变色
                rowHoverColor: true,//划过行变色
                displayBlankRows: false,//是否显示空白行, 默认值true
            ...
            tbShangPin = $.fn.bsgrid.init('tbShangPin', {
                url: '${cxt}/commonAction!seleceFittingsInfo.action',
                autoLoad: false,//自动加载
                stripeRows: true,//隔行变色
                rowHoverColor: true,//划过行变色
                displayBlankRows: false,//是否显示空白行, 默认值true
        ...
        //生成预约单号
        function PredateNum() {
            $.post("${cxt}/appointmentAction!predateNum.action", function (data) {
                $("#PredateNum").val(data);
        ...
        function create() {
            ...
            createSelect("RepairID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Repair");//车型下拉框
        ...
        function DetailEvent(length,Num)
        {
            ...
            if (Num == 2) {
                createSelect("CI" + length, "${cxt}/commonAction!selectAppendOption.action?type=SYS_Maintainability");
        ...
        function btnMainDelect()
        {
            ...
            if (PredateID != "") {
                $.post("${cxt}/appointmentAction!deleteListPredate.action?predateID=" + PredateID, function (data) {
                    if (data) {
        ...
        function btnMainSava() {
            ...
            if (CarNum == "") {
                ...
                layer.confirm('是否保存当前信息？', {
                    ...
                    $.ajax({
			                type: "POST",
			                url: "${cxt}/appointmentAction!updateListPredate.action",
			                data: {pwPredates: JSON.stringify(ArrPredate), sysPreRepairItemDetail: JSON.stringify(ArrPreRepairItem),
                                   sysPreProductDetail: JSON.stringify(ArrPreProduct) , sysPreOtherCostDetail: JSON.stringify(ArrPreOtherCost)},
        ...
        function ToMainten()
        {
            ...
            if (ToAudit != "false") {
                if (ToTransferOrder == "false") {
                     $.ajax({
			                type: "POST",
			                url: "${cxt}/customerAction!customer.action",
			                data: {pwPredate: JSON.stringify(ArrPredate), sysPreRepairItemDetail: JSON.stringify(ArrPreRepairItem),
                                   sysPreProductDetail: JSON.stringify(ArrPreProduct) , sysPreOtherCostDetail: JSON.stringify(ArrPreOtherCost)},
			                traditional:true,//阻止jquery对数组序列化
			                dataType:"text",
                            contentType:"application/x-www-form-urlencoded",
        ...
        function ToAudit() {
            ...
            if (PredateID != "") {
                ...
                $.post("${cxt}/appointmentAction!toAudit.action?predateID=" + $("#PredateID").val(), function (data) {
                    if (data) {
        ...
        function ToNotAudit() {
            $("#ToAudit").val("false");
            $.post("${cxt}/appointmentAction!toNotAudit.action?predateID=" + $("#PredateID").val(), function (data) {
                if (data) {
        ...
        {
            $.getJSON("${cxt}/commonAction!customerNum.action", function (data) {
        ...
        function btnSave() {
            ...
            var birthday=IdNumber.substr(6,4)+"-"+IdNumber.substr(10,2)+"-"+IdNumber.substr(12,2);
            if (Owner == "") {
            ...
            }else if (new Date(nowDate)-(new Date(birthday))<568080000000) {
                layer.tips('该客户未成年', '#KIdNumber');
        ...
        function PredateData(record)
        {
            var index = layer.load(0); //0代表加载的风格，支持0-2
            btnMainInsert(1);
            $.getJSON("${cxt}/appointmentAction!selectPredateDetail.action?predateID=" + record.predateId, function (data) {
            ...
            $("#PredateNum").val(record.predateNum.trim());
            $("#PredateNums").val(record.predateNum.trim());
            $("#MaintenanceNum").val(record.maintenanceNum.trim());
        ...
        function ShowShangPin() {
            ...
            $.getJSON("${cxt}/commonAction!selectFittingsType.action", function (data) {
        ...
        function btnFittingsSava()
        {
            ...
            if (FittingsCode == "") {
                ...
                if (FittingsCode!="") {
                    $.post("${cxt}/commonAction!judgingFittingsCode.action?fittingsCode=" + FittingsCode, function (data) {
                        if (data==true) {
       ...
       //主页面
        ...
        function PreProduct(PreProductDetailID,FittingsCode, FittingsName,FittingsSpec, VehicleType, Quantity,
            ...
            this.rreProductDetailId = PreProductDetailID;//产品明细ID
        ...
        function PreOtherCost(PreOtherCostDetailID, ExpensesID, Amount, Discount, AmountPaid, Remark) {
                this.rreOtherCostDetailId = PreOtherCostDetailID;//费用明细ID
