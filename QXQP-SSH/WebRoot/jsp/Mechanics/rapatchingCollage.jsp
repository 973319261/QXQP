   ...
   <div class="modal fade col-lg-12" id="AddPeiJianModal">
    ...
    <script>
        ...
        function create() {
            ...
            createSelect("ForeManID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_ForeMan");//领料员下拉框
            ...
            createSelect("PSuppliersID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Suppliers");//供应商下拉框
        ...
        function LoadInfo(ID) {
            ...
            $.ajaxSettings.async = false;
            $("#ReceptionID").val(ID);
             $.getJSON("${cxt}/collageAction!arrlistToCollage.action?receptionID=" + ID, function (data) {
                data=data[0];
            ...
            $.getJSON("${cxt}/collageAction!selectCollageData.action?receptionID=" + ID, function (data) {
                if(data!=null){
                data=data[0];
        ...
        function CollageDetaiData(CollageID) {
            ...
            var tbPeiJian = $("#tbPeiJian");
            $.getJSON("${cxt}/collageAction!selectCollageDetai.action?collageID=" + CollageID, function (data) {
        ...
        function BaveMianIofo() {
            ...
            if ($("#ForeMan").val() == "") {
                ...
                $.post("${cxt}/collageAction!updateListCollage.action", { pwCollage: JSON.stringify(ArrCollage), sysCollageDetai: JSON.stringify(ArrCollageDetai) }, function (data) {
                    if (data>0) {
                        layer.msg("已减配件库存，领料成功！");
                         $.post("${cxt}/collageAction!collage.action?receptionID=" + $("#ReceptionID").val(), function (data) {
