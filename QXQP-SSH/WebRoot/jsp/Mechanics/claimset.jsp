...
<body>
	...
	<nav class="breadcrumb" style="margin:0px"> <i
		...
		class="c-gray en">&gt;</span> <a href=""> 三 包 索 赔 结 算</a> <a
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20" style="padding:10px;margin:0px">
		<button class="btn btn-primary" onclick="Clear(0)">
			<i class="Hui-iconfont" id="btnInsert">&#xe604;</i> 新 增
		</button>
		<button class="btn btn-info " onclick="BavaMian()" id="btnBave">
			<i class="Hui-iconfont">&#xe632;</i> 保 存
		</button>
		<button class="btn btn-danger " onclick="DelectThreePacks()"
			id="btnDelect">
		...
		<button class="btn btn-info " onclick="ShowJieSuan()" id="btnColle">
			<i class="Hui-iconfont">&#xe692;</i> 收 款
		</button>
		<button class="btn btn-warning " onclick="TOAudit()" id="btnAudit">
			<i class="Hui-iconfont">&#xe634;</i> 审 核
		</button>
		<button class="btn btn-warning " onclick="TONotAudit()"
			id="btnNotAudit">
			<i class="Hui-iconfont">&#xe634;</i> 反 审 核
		</button>
	</div>
	<!--  @*控件栏*@ -->
	<fieldset class="layui-elem-field layui-field-title"
		...
		<legend
			style="margin-left:50px;text-shadow: 5px 5px 5px gray;font-weight:inherit">三
			包 索 赔 结 算</legend>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<form class="form-horizontal" role="form" style="margin-top:2px;"
						id="fromThreePacks">
						<input type="text" hidden id="ThreePacksID" name="ThreePacksID" />
						<input type="text" hidden id="ThreePacksDetailID"
							name="ThreePacksDetailID" /> <input type="text" id="CustomerNum"
							hidden>
						<!-- @*客户编码*@ -->
						<div class="form-group">
							<div class="col-lg-1 col-md-1 col-xs-12">
								<label class="control-label">索赔单号:</label>
							</div>
							<div class="col-lg-2 col-md-3 col-xs-12">
								<input type="text" class="form-control disabl" id="InsuranceNum"
									disabled>
							</div>
							<div class="col-lg-1 col-md-1 col-xs-12">
							...
							<div class="col-lg-2 col-md-3 col-xs-12">
								<div class="input-group" style="width:104%">
									<input type="text" class="form-control disabl"
										id="MaintenanceNum" disabled> <span
						...
						<div class="form-group">
							...
							<div class="col-lg-2 col-md-3 col-xs-12">
								<select class="form-control " id="ClaimComID"></select>
							</div>
							<div class="col-lg-1 col-md-1 col-xs-12">
								<label class="control-label">索赔员工:</label>
							</div>
							<div class="col-lg-2 col-md-3 col-xs-12">
							...
							<div class="col-lg-2 col-md-3 col-xs-12">
								<input type="text" class="form-control " id="SelfCoding">
							</div>
							<div class="col-lg-1 col-md-1 col-xs-12">
								<label class="control-label">车牌:</label>
							</div>
							<div class="col-lg-2 col-md-3 col-xs-12">
								<input type="text" class="form-control disabl" id="CarNum"
									disabled>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-2 col-md-3 col-xs-12">
								<input type="text" class="form-control disabl" id="Owner"
									disabled>
							</div>
							<div class="col-lg-1 col-md-1 col-xs-12">
							...
							<div class="col-lg-2 col-md-3 col-xs-12">
								<input type="text" class="form-control disabl" id="VehicleType"
									disabled>
							</div>
							<div class="col-lg-1 col-md-1 col-xs-12">
						...
						<div class="form-group">
							...
							<div class="col-lg-2 col-md-3 col-xs-12">
								<input type="text" class="form-control disabl" id="Operator"
									disabled value="${user.getUserName() }">
							</div>
							<div class="col-lg-1 col-md-1 col-xs-12">
							...
							<div class="col-lg-1 col-md-1 col-xs-12">
								<input type="hidden" id="ToAudit" value="false" /> <label
									class="control-label"
									style="position:relative;bottom:5px;left:30px">已审核: <input
									type="checkbox"
	...
	<div class="col-lg-12" id="myVue" style="margin:15px">
		...
		</el-tab-pane> <el-tab-pane label="领用配件">
		<div class="Boxs">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">历史索赔单查询</h4>
				</div>
								...
								<form class="form-horizontal" role="form"
									...
									<div class="form-group">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 reset"
											...
											<input type="text" class="form-control" id="DMaintenanceNum"
												onkeyup="" />
										</div>
										<div class="col-lg-1 col-md-1 col-sm-1 text-right">
										...
										<div class="col-lg-3 col-md-3 col-sm-12 reset"
											style="margin-top:3px">
											<input type="text" class="form-control" id="DCarNum"
												onkeyup="" />
										</div>
										<div class="col-lg-1 col-md-1 col-sm-1 text-right">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">×</button>
					<h4 class="modal-title">维修单号查询</h4>
				</div>
				<div class="modal-body">
					<div class="navsearch" style="height:100px">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<form class="form-horizontal" role="form" style="margin-top:2px;">
								<div class="form-group">
									...
									<div class="col-lg-3 col-md-3 col-sm-12 reset"
										style="margin-top:3px">
										<input type="text" class="form-control" id="HMaintenanceNum"
											onkeyup="" />
									</div>
									<div class="col-lg-1 col-md-1 col-sm-1 text-right">
										<label class="control-label">车 牌</label>
									...
									<div class="col-lg-3 col-md-3 col-sm-12 reset"
										style="margin-top:3px">
										<input type="text" class="form-control" id="HCarNum"
											onkeyup="" />
									</div>
									<div class="col-lg-1 col-md-1 col-sm-1 text-right">
										<label class="control-label">单据状态</label>
								...
								<div class="col-lg-4 col-md-4 col-sm-12 ">
									<button type="button" class="btn btn-search" id=""
										onclick="SeleceDanHao()">
										<i class="glyphicon glyphicon-search"></i>查 询
									</button>
									<button type="button" class="btn btn-info" id="">
										<i class="glyphicon glyphicon-ok-sign"></i>选 中
	...
	<div class="modal fade col-lg-12" id="JieSuanModal">
		<div class="modal-dialog">
			<div class="modal-content" style="width: 520px;left:0;height: 67%">
				...
				<div class="modal-body" style="padding-top:0">
					...
					<fieldset class="layui-elem-field layui-field-box"
						...
						<p style="padding-left:10px">
							客户编号：<span class="span" id="JCustomerNum"></span>客户姓名：<span
								id="JOwner"></span>
						</p>
						<p style="padding-left:10px">
							单据时间：<span class="span" id="JBalanceDate"></span>业务单号：<span
								id="JMaintenanceNum"></span>
						</p>
						<p style="padding-left:10px">
							应收金额：<span class="span" id="JShouldAmount">0.00</span>已优惠金额：<span
								id="JOptimalAmount">0.00</span>
						</p>
						<p style="padding-left:10px">
							已收金额：<span class="span" id="JCollectionAmount">0.00</span>未收金额：<span
								id="JNoAmount"></span>
						</p>
						<form class="form-horizontal" role="form" style="margin-top:2px;"
							id="formBalance">
							<input hidden id="ReceptionID" value="${receptionID }" /> <input
								hidden id="BalanceID" />
							<!-- @*结算ID*@ -->
							<div class="col-lg-8 col-md-8 col-sm-8">
								<div class="form-group">
									...
									<div class="col-lg-7 col-md-7 col-sm-7">
										<input type="text" class="form-control" id="OptimalAmount"
								...
								<div class="form-group">
									...
									<div class="col-lg-7 col-md-7 col-sm-7">
										<input type="text" class="form-control" id="CollectionAmount"
											onkeyup="" onKeyUp="value = value.replace(/[^\d.]/g, '')" />
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-5 col-md-5 col-sm-5 ">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="form-group">
									...
									<div class="col-lg-6 col-md-6 col-sm-6">
										<input type="text" class="form-control" id="Remark" onkeyup=""
											style="width:205px" />
									</div>
								</div>
							</div>
				...
				<div class="modal-footer" style="border-top:none;">
					<div class="col-lg-12 col-md-12 col-sm-12 ">
						<button class="btn btn-info " onclick="btnBaveJieSuan()">
							<i class="Hui-iconfont">&#xe632;</i> 保存
						</button>
						<button class="btn btn-pink">
							<i class="Hui-iconfont">&#xe652;</i> 打 印
						</button>
						<button type="button" class="btn btn-default" data-dismiss="modal"
							id="btnClose">
							<i class="glyphicon glyphicon-remove"></i>取 消
						</button>
					</div>
				</div>
			</div>
	...
	<script>
        ...
        $(function () {
            ...
            tbDanJu = $.fn.bsgrid.init('tbDanJu', {
                url: '${cxt}/claimsetAction!selectThreePacks.action',
                autoLoad: false,//自动加载
            ...
            tbDanHao = $.fn.bsgrid.init('tbDanHao', {
                url: '${cxt}/claimsetAction!selectDanHao.action',
                autoLoad: false,//自动加载
                stripeRows: true,//隔行变色
                rowHoverColor: true,//划过行变色
                displayBlankRows: false,//是否显示空白行, 默认值true
        ...
        function create() {
            ...
            appendOption("HDocumentStateID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_DocumentState");//单据状态下拉框
            appendOption("HBalanceStateID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_BalanceState");//结算状态下拉框
        ...
        function InsuranceNum() {
            $.post("${cxt}/claimsetAction!insuranceNum.action", function (data) {
        ...
        function MianDatas() {
            if (ReceptionID != "") {
                $.getJSON("${cxt}/claimsetAction!selectThreePackss.action?receptionID=" + ReceptionID, function (data) {
                    DanHaoData(data[0]);
                })
            } else {
                SeleceDanJu();
            }
            $.post("${cxt}/claimsetAction!clearClaimset.action");
        }
        /********************主页面---开始******************************/
        //删除数据
        function DelectThreePacks()
        {
            var ThreePacksID = $("#ThreePacksID").val();
            if (ThreePacksID != 0) {
                $.post("${cxt}/claimsetAction!delectThreePacks.action?threePacksID=" + ThreePacksID, function (data) {
                    if (data) {
                        layer.msg("删 除 成 功 ！");
                        SeleceDanJu();
                        Clear();
        ...
        function BavaMian()
        {
            ...
            } else if (ClaimComID == 0){
                layer.alert("请选择索赔厂家！")
            } else {
                $.post("${cxt}/claimsetAction!bavaThreePacks.action", { pwThreePacks: JSON.stringify(ArrThreePacks), claimComID: $("#ClaimComID").val() }, function (data) {
                    if (data>0) {
                        SeleceDanJu()
                        $("#ThreePacksID").val(data);
                        if (data != false) {
        ...
        function TOAudit() {
            ...
            if (ThreePacksID != "") {
                $("#ToAudit").val("true");
                $.post("${cxt}/claimsetAction!toAudit.action?threePacksID=" + ThreePacksID, function (data) {
                    if (data>0) {
        ...
        function TONotAudit() {
            ...
            $.getJSON("${cxt}/claimsetAction!selectBalance.action?businessNum=" + InsuranceNum, function (data) {
                if (data.state && data.states!="A") {
                    $.post("${cxt}/claimsetAction!toNotAudit.action?threePacksID=" + $("#ThreePacksID").val(), function (data) {
                        if (data) {
        ...
        function AuditEvent() {
            ...
            $("#fromThreePacks input").attr("disabled", true);
            $("#fromThreePacks select").attr("disabled", true);
            $("#fromThreePacks button").attr("disabled", true);
        }
        //反审核按钮状态
        function NotAuditEvent() {
            ...
            $("#fromThreePacks input").attr("disabled", false);
            $("#fromThreePacks select").attr("disabled", false);
            $("#fromThreePacks button").attr("disabled", false);
        ...
        {
          Clear();
          $.getJSON("${cxt}/claimsetAction!selectReceptionDetail.action?receptionID=" + record.receptionId, function (data) {
        ...
        {
        console.log(record)
            var ThreePacksDetailID = record.threePacksDetailId;
            $.getJSON("${cxt}/claimsetAction!selectThreePacksData.action?threePacksDetailID=" + ThreePacksDetailID, function (data) {
                if (data != null) {
                    DanJuData(data[0]);
                } else {
                    MianData(record);
                    ...
                    $("#ClaimComID").val(record.claimComId);
                    $("#CustomerNum").val(record.customerNum);
                    $("#ThreePacksDetailID").val(record.threePacksDetailId);
        ...
        function DanJuData(record)
        {
            MianData(record);
            $("#ReceptionID").val(record.receptionId);
            $("#ThreePacksID").val(record.threePacksId);
            $("#ThreePacksDetailID").val(record.threePacksDetailId);
            ...
            $("#MaintenanceNum").val(record.maintenanceNum);
            $("#ClaimComID").val(record.claimComId);
            $("#ClaimsStaff").val(record.claimsStaff);
        ...
        function ShowJieSuan() {
            $.getJSON("${cxt}/claimsetAction!selectBalance.action?businessNum=" + $("#InsuranceNum").val(), function (data) {
                if (data.state) {
                    if ($("#Amount").val() < 0) {
        ...
        function btnBaveJieSuan() {
            ...
            if ($("#PaymentID").val() == 0) {
                ...
                $.post("${cxt}/claimsetAction!baveBalance.action", { pwBalance: JSON.stringify(ArrBalance) }, function (data) {
                    if (data>0) {
                        layer.msg("结 算 成 功 !");
                        SeleceDanJu();
        ...
        /********************结算单模态框---结束*******************************/
        //三包表
        function ThreePacks(ThreePacksID, ThreePacksDetailID, InsuranceNum, OpenDate, BalanceDate, ClaimsStaff,
            SelfCoding, Remark, Amount, ToAudit, Operator, ToTicket)
        {
