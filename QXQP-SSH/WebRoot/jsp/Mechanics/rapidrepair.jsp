                    ...
                    <div>
                        ...
                        <div class="modTow col-lg-12 col-md-12 col-sm-12">
                           <form class="form-horizontal" role="form" id="formMaintenanceCus"
								action="${cxt}/commonAction!updateMaintenanceCus.action"
								method="post">
								<input id="KMaintenanceCusID" type="text"
									name="sysMaintenanceCus.maintenanceCusId" hidden />
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
										<label class="control-label">车主:</label>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KOwner"
											name="sysMaintenanceCus.owner" maxlength="5">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control Date" id="KBirthday"
											name="sysMaintenanceCus.birthday">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KIdNumber"
											name="sysMaintenanceCus.idNumber" maxlength="18">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KMobilePhone"
											name="sysMaintenanceCus.mobilePhone" maxlength="15">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KLicenseCode"
											name="sysMaintenanceCus.licenseCode" maxlength="7">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
										<label class="control-label">车型:</label>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12" style="height:36px">
										<select class="form-control" id="KVehicleTypeID"
											...
											id="KVehicleType" name="sysMaintenanceCus.vehicleType" maxlength="10">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KEngineNum"
											name="sysMaintenanceCus.engineNum" maxlength="15">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KFrameNum"
											name="sysMaintenanceCus.frameNum" maxlength="15">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KRepairMan"
											name="sysMaintenanceCus.repairMan" maxlength="5">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
										<label class="control-label">送修人电话:</label>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KRepairTele"
											name="sysMaintenanceCus.repairTele" maxlength="15">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KInsuranceComID"
											name="sysMaintenanceCus.insuranceComId"></select>
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KInsuranceSpeID"
											name="sysMaintenanceCus.insuranceSpeId"></select>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control Date"
											id="KInitialStartDate" name="sysMaintenanceCus.initialStartDate">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control Date"
											id="KInitialEndDate" name="sysMaintenanceCus.initialEndDate">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KAddress"
											name="sysMaintenanceCus.address" maxlength="15">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KCustomerNum"
											name="sysMaintenanceCus.customerNum" disabled maxlength="20">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control Date" id="KDriveDate"
											name="sysMaintenanceCus.driveDate">
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
										<label class="control-label">所属区域:</label>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KRegionID" name="sysMaintenanceCus.regionId"></select>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KDepartmentID"
											name="sysMaintenanceCus.departmentId"></select>
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
										<label class="control-label">所属员工:</label>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KCarderID" name="sysMaintenanceCus.carderId"></select>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KCustomerLevelID"
											name="sysMaintenanceCus.customerLevelId"></select>
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
										<label class="control-label">客户来源:</label>
									</div>
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KCustomerSouID"
											name="sysMaintenanceCus.customerSouId"></select>
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<select class="form-control" id="KCustomerTypeID"
											name="sysMaintenanceCus.customerTypeId"></select>
									</div>
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control Date" id="KDrivingDate"
											name="sysMaintenanceCus.drivingDate">
									</div>
								</div>
								<div class="form-group">
									<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<div class="col-lg-4 col-md-4 col-xs-12">
										<input type="text" class="form-control" id="KInputPerson"
											name="sysMaintenanceCus.inputPerson" maxlength="5"
    ...
    <script>
        ...
        $(function () {
            ...
            tbKeHu = $.fn.bsgrid.init('tbKeHu', {
                url: '${cxt}/commonAction!seleceMaintenanceCus.action',
                autoLoad: false,//自动加载
            ...
            tbDanJu = $.fn.bsgrid.init('tbDanJu', {
                url: '${cxt}/customerAction!selectReception.action',
                autoLoad: false,//自动加载
                stripeRows: true,//隔行变色
                rowHoverColor: true,//划过行变色
                displayBlankRows: false,//是否显示空白行, 默认值true
        ...
        function addOne() {
            ...
            if (RepairItemID != 0) {
                $.getJSON("${cxt}/commonAction!selectRepairItemChange.action?repairItemID=" + RepairItemID, function (data) {
        ...
        function addTow()
        {
            var ReceptionID = $("#ReceptionID").val();
            if (ReceptionID != "") {
                $.post("${cxt}/collageAction!collage.action?receptionID=" + ReceptionID, function (data) {
        ...
        function addThree() {
           ...
           selectcreate("QA" + length, ArrExpensesData);
            var ExpensesID = $("#QA" + length).val();
             $.getJSON("${cxt}/commonAction!selectExpensesChange.action?expensesID=" + ExpensesID, function (data) {
        ...
        function MaintenanceNum() {
            $.post("${cxt}/rapidrepairAction!maintenanceNum.action", function (data) {
        ...
        function create() {
            $.ajaxSettings.async = false;
            createSelect("VehicleTypeID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_VehicleType");//车型下拉框
            createSelect("CarderID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Carder");//接车人下拉框
            appendOption("RepairID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Repair");//车型下拉框
            appendOption("CustomerSouID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_CustomerSou");//客户来源下拉框
            appendOption("InsuranceComID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_InsuranceCom");//保险公司下拉框
            appendOption("ClaimComID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_ClaimCom");//索赔厂家下拉框

            createSelect("KVehicleTypeID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_VehicleType");//车型下拉框
            appendOption("KInsuranceComID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_InsuranceCom");//保险公司下拉框
            appendOption("KInsuranceSpeID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_InsuranceSpe");//保险种类下拉框
            appendOption("KDepartmentID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Department");//部门下拉框
            appendOption("KCarderID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Carder");//接车人下拉框
            appendOption("KCustomerLevelID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_CustomerLevel");//客户等级下拉框
            appendOption("KCustomerTypeID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_CustomerType");//客户类型下拉框
            appendOption("KRegionID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Region");//区域下拉框
            appendOption("KCustomerSouID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_CustomerSou");//区域下拉框

            appendOption("PFittingsTypeID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_FittingsType");//商品类别下拉框
            appendOption("PSystemUnitID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_SystemUnit");//系统单位下拉框
            createSelect("PVehicleTypeID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_VehicleType");//车型下拉框
            appendOption("PSuppliersID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Suppliers");//供应商下拉框

            appendOption("DDocumentStateID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_DocumentState");//单据状态下拉框
            appendOption("DBalanceStateID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_BalanceState");//结算状态下拉框

            appendOption("PaymentID", "${cxt}/commonAction!selectAppendOption.action?type=SYS_Payment");//付款方式下拉框
            $.getJSON("${cxt}/commonAction!selectAppendOption.action?type=SYS_Maintainability", function (data) {
                for (var i = 0; i < data.length; i++) {
                    ArrMaintainData.push(data[i]);
                }
            })
            $.getJSON("${cxt}/commonAction!selectAppendOption.action?type=SYS_Expenses", function (data) {
                for (var i = 0; i < data.length; i++) {
                    ArrExpensesData.push(data[i]);
                }
            })
            $.getJSON("${cxt}/commonAction!selectAppendOption.action?type=SYS_RepairItem", function (data) {
                for (var i = 0; i < data.length; i++) {
                    ArrRepairItemDate.push(data[i]);
                }
            })
            $.getJSON("${cxt}/commonAction!selectAppendOption.action?type=SYS_Maintenance", function (data) {
                for (var i = 0; i < data.length; i++) {
                    ArrMaintenanceDate.push(data[i]);
                }
            })
            $.getJSON("${cxt}/commonAction!selectAppendOption.action?type=SYS_MaintenanceCrew", function (data) {
                ArrMaintenanceCrew.push({id:"0",name:"--请选择--"});
                for (var i = 0; i < data.length; i++) {
                    ArrMaintenanceCrew.push(data[i]);
                }
            })
            $.getJSON("${cxt}/commonAction!selectAppendOption.action?type=SYS_RepairMan", function (data) {
                ArrRepairMan.push({id:"0",name:"--请选择--"});
                for (var i = 0; i < data.length; i++) {
                    ArrRepairMan.push(data[i]);
                }
            })
            $.getJSON("${cxt}/commonAction!selectAppendOption.action?type=SYS_Warehouse", function (data) {
                for (var i = 0; i < data.length; i++) {
        ...
        function DetailEvent(length, Num) {
            if (Num == 1) {
                var Price = 0;
                $.post("${cxt}/dispatchingAction!selectDispatch.action?dispatchID=" + 1, function (data) {
                Price = data;
                })
                Datetime();
        ...
        {
            if (ReceptionID!="") {
            $.getJSON("${cxt}/dispatchingAction!selectReception.action?receptionID=" +ReceptionID, function (data) {
                ReceptionData(data);
                 $.post("${cxt}/collageAction!cleanArrlist.action");
            })
          }
        }
        /********************主页面信息---开始*******************************/
        ...
        function btnMainInsert(data) {
            ...
            $("#CollageState").text("未领料")
            $("#ToSendWork").text("未派工")
            $("#DocumentState").text("未结算")
            $("#ToAudits").text("未审核")
            $("#BalanceState").text("未结算")
            ClearDetailToT();
            MaintenanceNum();
            $("#ToAudit").val("false");
           NotAuditEvent();
        ...
        function btnMainDelect() {
            ...
            if (ReceptionID != "") {
                layer.confirm('是否删除当前信息？', {
                    ...
                    $.post("${cxt}/customerAction!delectReception.action?receptionID=" + ReceptionID, function (data) {
                        if (data) {
        ...
        function btnMainSava(num) {
            ...
            function Bave()
            {
                layer.confirm('是否保存当前信息？', {
                 ...
                 $.post("${cxt}/rapidrepairAction!updateListReceptione.action", {
                        pwReception: JSON.stringify(ArrReception), sysRecRepairItemDetail: JSON.stringify(ArrRecRepairItem),
                        sysCollageDetai: JSON.stringify(ArrCollageDetai), sysRecOtherCostDetail: JSON.stringify(ArrRecOtherCost),
                        ...
                        if (data != false) {
                            if (num == 0) {
                                ...
                                $.post("${cxt}/collageAction!collage.action?receptionID=" + data, function (data) {
                                    window.location.href = "${cxt}/jsp/Mechanics/rapatchingCollage.jsp";
                                })
                            }
                        } else {
        ...
        function TOAudit() {
            ...
            if (ReceptionID != "") {
                $("#ToAudit").val("true");
                $.post("${cxt}/settlementAction!toAudit.action?receptionID=" + ReceptionID, function (data) {
                    if (data>0) {
        ...
        function TONotAudit() {
            ...
            $.getJSON("${cxt}/claimsetAction!selectBalance.action?businessNum=" + MaintenanceNum, function (data) {
                if (data.state && data.states != "A") {
                    $.post("${cxt}/settlementAction!toNotAudit.action?receptionID=" + $("#ReceptionID").val(), function (data) {
                        if (data>0) {
        ...
        function InsuranceData() {
            ...
            if (ReceptionID != "") {
                if ($("#InsuranceMoney").val() > 0) {
                    $.post("${cxt}/insuranceAction!insurance.action?receptionID=" + ReceptionID, function (data) {
        ...
        function ThreePacksData() {
            ...
            if (ReceptionID != "") {
                if ($("#ClaimMoney").val() > 0) {
                    $.post("${cxt}/claimsetAction!claimset.action?receptionID=" + ReceptionID, function (data) {
        ...
        function CustomerNumData() {
           $.post("${cxt}/commonAction!customerNum.action", function (data) {
        ...
        function ReceptionData(record) {
            btnMainInsert(1);
            var ArrReception = [], ArrRecRepairItem = [], ArrCollageDetai = [], ArrRecOtherCost = [], ArrInsuranceMoney = [], ArrThreePacksDetail = [];
             $.getJSON("${cxt}/settlementAction!selectBalanceDetail.action?receptionID=" + record.receptionId, function (data) {
                ...
                $.each(data[0], function (i) {
                    ...
                    var tr = $("<tr><td>" + length + "</td><td><select id=WA" + length + "></select></td><td><select id=WB" + length + " class='Disabled' ></select></td>"
                        ...
                        + "<td onclick='tdclick(this)' id=WJ" + length + ">" + data[0][i].jobAmount + "</td><td ><input id=WK" + length + " class='Date'value="+ formatToDate(data[0][i].completionDate) + "></td>"
        ...
        function ShowJieSuan() {
            $.getJSON("${cxt}/claimsetAction!selectBalance.action?businessNum=" + $("#MaintenanceNum").text(), function (data) {
              $("#BalanceID").val("");
                if (data.state) {
                    if(data.text!=null){
                     $("#BalanceID").val(data.text);
                    $.getJSON("${cxt}/claimsetAction!selectBalances.action?balanceID=" + $("#BalanceID").val(), function (data) {
        ...
        function JieSuanData() {
            ...
            $("#Remark").val("");
            if (BalanceID != "") {
               $.getJSON("${cxt}/claimsetAction!selectBalances.action?balanceID=" + BalanceID, function (data) {
                    var NoAmount = parseFloat(data.shouldAmount - data.collectionAmount - data.optimalAmount);//未收金额
        ...
        function btnBaveJieSuan() {
            ...
            if ($("#PaymentID").val() == 0) {
                ...
                $.post("${cxt}/settlementAction!baveBalance.action", { pwBalance: JSON.stringify(ArrBalance) }, function (data) {
                    if (data>0) {
                        $("#DocumentState").text("完工已结算");
                        $("#BalanceState").text("已结算");
                        layer.msg("结 算 成 功 !");
                        SeleceReception();
