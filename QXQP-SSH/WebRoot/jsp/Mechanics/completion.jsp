    ...
    <script>
        ...
        $(function () {
            tbReception = $.fn.bsgrid.init('tbReception', {
                url: '${cxt}/completionAction!selectReception.action',
                autoLoad: false,//自动加载
        ...
        function CompletionTrue()
        {
            ...
            if (record.length > 0) {
                $.post("${cxt}/completionAction!updateCompletionTrue.action", { receptionVo: JSON.stringify(ReceptionID) }, function (data) {
                    if (data>0) {
                        SelectReception()
                        layer.msg("修 改 成 功 !")
                    } else {
        ...
        function CompletionFalse()
        {
            ...
            $.post("${cxt}/completionAction!updateCompletionFalse.action", { receptionVo: JSON.stringify(ReceptionID) }, function (data) {
                    if (data>0) {
                        SelectReception()
                        layer.msg("修 改 成 功 !")
                    }
