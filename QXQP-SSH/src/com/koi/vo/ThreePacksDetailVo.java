...
public class ThreePacksDetailVo implements java.io.Serializable {
	...
	/** default constructor */
	public ThreePacksDetailVo() {
	}


	public ThreePacksDetailVo(Integer receptionId, Integer documentStateId,
			...
			Integer threePacksDetailId, Integer threePacksId, String operator,
			Integer claimComId, Double claimMoney) {
		super();
